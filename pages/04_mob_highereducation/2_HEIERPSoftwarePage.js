// 📁 File: pages/04_mob_highereducation/2_HEIERPSoftwarePage.js
...
export class HEIERPSoftwarePage extends BasePage {
  ...
  async navigateToHEIERP() {
    console.log("📂 Clicking Higher Education...");
    await this.page.locator(this.higherEducationLink).click();
    await this.wait(1);

    console.log("🧭 Clicking HEI ERP Software using XPath...");
    await this.page.locator(`xpath=${this.heiERPLink}`).click();
    await this.wait(2);

    console.log("✅ HEI ERP Software page opened!");
  }

  async verifyHEIERPPageContent() {
    console.log("🔍 Starting HEI ERP Software page verification...");
